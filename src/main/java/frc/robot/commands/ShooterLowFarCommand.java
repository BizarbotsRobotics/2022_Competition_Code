...
public class ShooterLowFarCommand extends CommandBase {
  ...
  public ShooterLowFarCommand(ShooterSubsystem shooter, VisionSubsystem vision, ConveyorSubsystem conveyor, FeederSubsystem feeder, IntakeSubsystem intake) {
  ...
  public void execute() {
    if( this.vision.isAligned()) {
      int setPoint = this.shooter.calculateShooterSpeed(GOAL_TYPE.LOW, POSITION.FAR);
